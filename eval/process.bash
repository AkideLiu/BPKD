...
cd $DIR
python tools/model_converters.py checkpoints/$checkpoint_name --out-path checkpoints/pascal_student
PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:512 python tools/test.py $config_name checkpoints/pascal_student/$checkpoint_name_student --eval mIoU

echo $checkpoint_name
ls checkpoints/pascal_student/
